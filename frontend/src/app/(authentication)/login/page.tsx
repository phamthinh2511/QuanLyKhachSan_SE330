    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <span className="text-white text-2xl font-bold tracking-tight">Hotel Manager</span>
        </div>

        {/* Card */}
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
          <h2 className="text-white text-2xl font-semibold mb-1">Đăng nhập</h2>
          <p className="text-blue-200 text-sm mb-8">Chào mừng trở lại! Vui lòng đăng nhập.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Username */}
            <div>
              <label className="text-blue-100 text-sm font-medium mb-1.5 block">Tên đăng nhập</label>
            ...
            {/* Password */}
            <div>
              <label className="text-blue-100 text-sm font-medium mb-1.5 block">Mật khẩu</label>
              <div className="relative">
